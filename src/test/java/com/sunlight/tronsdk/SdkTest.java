...
public class SdkTest {
	...
	public void testSendTrxTransaction() throws Exception {
		TransactionResult transactionResult = TrxHelper
				.transfer(senderPrivateKey, receiverAddress, BigDecimal.valueOf(10));
	...
	public void testSendTrc10Transaction() throws Exception {
		...
		TransactionResult transactionResult = Trc10Helper
				.transfer(senderPrivateKey, receiverAddress, BigDecimal.ONE, assetName, coinDecimal);
		LOGGER.info("transactionResult:" + JSON.toJSONString(transactionResult));
	}
	...
	public void sendTrc20TransactionTest() throws Exception {
		TransactionResult transactionResult = Trc20Helper
				.transfer(senderPrivateKey, receiverAddress, BigDecimal.valueOf(0.1),
	...
	public void trc20BalanceOfTest() throws Exception {
		BigDecimal balance = Trc20Helper
				.balanceOf("TT7bh9H6o8hVXXQ4L3q5Cp17LASmW9ud2y", "TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t");
		LOGGER.info("balance:" + balance);
	...
	public void trc20DecimalTest() throws Exception {
		Integer decimals = Trc20Helper
				.decimals("TT7bh9H6o8hVXXQ4L3q5Cp17LASmW9ud2y", "TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t");
	...
	public void getBlockByHeightTest() throws Exception {
		String data = TrxQuery.getBlockByHeight(BigInteger.valueOf(	13868561));
		LOGGER.info("data:" + data);
	}
	...
	public void getTransactionByIdTest() throws Exception {
		String data = TrxQuery.getTransactionById("4754467cd09db170132b1f4d4219f158d447e3d0c245bc26a7a9f3b65f7a7a59");
		LOGGER.info("data:" + data);
	}
	...
	public void getTransactionInfoByIdTest() throws Exception {
		String data = TrxQuery
				.getTransactionInfoById("4754467cd09db170132b1f4d4219f158d447e3d0c245bc26a7a9f3b65f7a7a59");
		LOGGER.info("data:" + data);
	}
	...
	public void freezeBalanceTest() throws Exception {
		//能量
		TransactionResult transactionResult = TrxHelper
				.freezeBalance(senderPrivateKey, BigDecimal.ONE, Common.ResourceCode.ENERGY);
		LOGGER.info("transactionResult:" + JSON.toJSONString(transactionResult));

		transactionResult = TrxHelper
				.freezeBalance(senderPrivateKey, BigDecimal.ONE, "TT7bh9H6o8hVXXQ4L3q5Cp17LASmW9ud2y",
						Common.ResourceCode.ENERGY);
		LOGGER.info("transactionResult:" + JSON.toJSONString(transactionResult));

		//带宽
		transactionResult = TrxHelper.freezeBalance(senderPrivateKey, BigDecimal.ONE, Common.ResourceCode.BANDWIDTH);
		LOGGER.info("transactionResult:" + JSON.toJSONString(transactionResult));
	}
	...
	public void unFreezeBalanceTest() throws Exception {
		...
		transactionResult = TrxHelper
				.unFreezeBalance(senderPrivateKey, Common.ResourceCode.ENERGY, "TT7bh9H6o8hVXXQ4L3q5Cp17LASmW9ud2y");
		LOGGER.info("transactionResult:" + JSON.toJSONString(transactionResult));
	}
